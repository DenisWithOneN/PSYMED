...
<template>
  <div class="container mx-auto md:hidden flex flex-col items-center">
    <img
      class="w-64"
  ...
  <img
    ...
    src="F:\Universitate\Code\TAW\psymed\src\assets\Line 3.svg"
    alt="hero line"
  />
  <div class="container mx-auto md:hidden flex flex-col items-center justify-center">
    ...
    <FilledButton class="my-2 mt-6" buttonText="programeaza-te" buttonColor="bg-master_mint"></FilledButton>
    <EmptyButton class="my-3" buttonText="contact" borderColor="border-master_mint" textColor="text-master_mint"></EmptyButton>
    <div></div>
  </div>
</template>
<style></style>
